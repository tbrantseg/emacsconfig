...
Place commonly used global keybindings here.
...
#+BEGIN_SRC emacs-lisp
  (defun rtags-start-unless-running-or-remote ()
    "Wrapper around rtags-start-process-unless-running to avoid problems with remote files"
    (unless (file-remote-p default-directory)
      'rtags-start-process-maybe))

  (add-hook 'c++-mode-hook 'rtags-start-unless-running-or-remote)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp  
  ...
  (setq ob-ipython-command "ipython --simple-prompt")
...
(defun my-org-confirm-babel-evaluate (lang body)
  (not (member lang '("ditaa" "dot" "plantuml" "ipython" "python" "sh" "gnuplot"))))
...
#+BEGIN_SRC emacs-lisp
  (defun my-library-of-babel-setup ()
    (setq org-babel-lob-files '("~/emacs-init/code-blocks.org")))
  (add-hook 'org-mode-hook 'my-library-of-babel-setup)
#+END_SRC
